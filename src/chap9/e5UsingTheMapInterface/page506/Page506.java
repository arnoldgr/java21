...
//        Lines 7 and 8 give different output, showing that get() returns null when the key is not present.
...
//        Line 26 calls a function and sets the value of each element of the map to the result of that function.
