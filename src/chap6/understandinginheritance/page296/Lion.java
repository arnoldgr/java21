package chap6.understandinginheritance.page296;
...
//There’s a lot going on here, we know! The age variable exists in the parent Animal class and is not directly
// accessible in the Lion child class. It is indirectly accessible via the setAge() method.
...
//
//Let’s take a look at the members of the Lion class. The instance variable age is marked private and is not directly accessi
//ble from the subclass Lion. Therefore, the following would not compile:
//public class Lion extends Animal {
//    public void roar() {
//        System.out.print("Lion's age: " + age);  // DOES NOT COMPILE, use the public getAge method
//    }
//}
//
